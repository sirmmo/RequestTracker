...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Response.legal_pursue'
        db.alter_column('core_response', 'legal_pursue', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Response.legal_support'
        db.alter_column('core_response', 'legal_support', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Response.legal_pursue'
        db.alter_column('core_response', 'legal_pursue', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Response.legal_support'
        db.alter_column('core_response', 'legal_support', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        'core.response': {
            ...
            'dissatisfaction_reason': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['core.DissatisfactionType']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'legal_pursue': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'legal_sig': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'legal_support': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
