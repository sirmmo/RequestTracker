...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Request.area'
        db.add_column('core_request', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Topic']),
                      keep_default=False)


        # Changing field 'Request.topic'
        db.alter_column('core_request', 'topic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Area']))

    def backwards(self, orm):
        # Deleting model 'Area'
        db.delete_table('core_area')

        # Deleting field 'Request.area'
        db.delete_column('core_request', 'area_id')


        # Changing field 'Request.topic'
        db.alter_column('core_request', 'topic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Topic']))
    ...
    models = {
        ...
        'core.request': {
            ...
            'area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Topic']"}),
            ...
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Area']"})
        },
        'core.requester': {
        ...
        'core.response': {
            ...
            'satisfaction_level': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.SatisfactionLevel']"})
        },
