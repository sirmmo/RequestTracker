...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requester.security_question'
        db.add_column('core_requester', 'security_question',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'Requester.security_answer'
        db.add_column('core_requester', 'security_answer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requester.security_question'
        db.delete_column('core_requester', 'security_question')

        # Deleting field 'Requester.security_answer'
        db.delete_column('core_requester', 'security_answer')
