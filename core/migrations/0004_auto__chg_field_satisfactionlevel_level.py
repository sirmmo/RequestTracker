...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SatisfactionLevel.level'
        db.alter_column('core_satisfactionlevel', 'level', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'SatisfactionLevel.level'
        db.alter_column('core_satisfactionlevel', 'level', self.gf('django.db.models.fields.IntegerField')())
