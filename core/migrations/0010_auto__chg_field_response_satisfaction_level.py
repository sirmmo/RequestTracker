...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Response.satisfaction_level'
        db.alter_column('core_response', 'satisfaction_level_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.SatisfactionLevel']))

    def backwards(self, orm):

        # Changing field 'Response.satisfaction_level'
        db.alter_column('core_response', 'satisfaction_level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SatisfactionLevel'], null=True))
